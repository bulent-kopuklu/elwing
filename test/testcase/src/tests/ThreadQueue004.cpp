...
std::string ThreadQueue004::getDescription() const
{
    std::stringstream strm;
    strm << "elw::ThreadQueu test." << " create 2 producer threads and create 2 consumer threads and pop from queu. msg cnt:" << MSGCNT;
    return strm.str();
}

bool ThreadQueue004::run()
{
